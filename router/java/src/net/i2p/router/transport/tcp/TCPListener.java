 ...
 */
class TCPListener {
    private final static Log _log = new Log(TCPListener.class);
    private TCPTransport _transport;
    private TCPAddress _myAddress;
    private ServerSocket _socket;
    private ListenerRunner _listener;
    
    public TCPListener(TCPTransport transport) {
	_myAddress = null;
	...
	public void run() {
		...
		TCPConnection c = new RestrictiveTCPConnection(_socket, _transport.getMyIdentity(), _transport.getMySigningKey(), false);
