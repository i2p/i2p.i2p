...
class TunnelPoolPersistenceHelper {
    private final static Log _log = new Log(TunnelPoolPersistenceHelper.class);
	...
	ClientTunnelPool cpool = new ClientTunnelPool(dest, settings, pool);
	...
	String str = Router.getInstance().getConfigSetting(PARAM_TUNNEL_POOL_FILE);
